...
#Child Classes
class Fire(Pykemon):
    """A Fire based Pykemon is a child of the Pykemon parent class."""
...
class Water(Pykemon):
    """A Water based Pykemon is a child of the Pykemon parent class."""
...
class Grass(Pykemon):
    """A Grass based Pykemon is a child of the Pykemon parent class."""
    ...
    def special_attack(self, enemy):
        """Leaf Blade: an elemental water move. Massive damage to water type,
...
class Game():
    ...
    def __init__(self):
        """Initialize attributes"""
        #Upon creating a pykemon, element and name wil be chosen randomly
        self.pykemon_elements = ["Fire", "Water", "Grass"]
        self.pykemon_names = ["Squarpuf", "Rotator", "Lobumsor", "Snarga", "Liffle", "Scrutana", "Powdrill",
                              "Varalac", "Gutatchu", "Ramdan", "Cirullin", "Aralana", "Dixlof", "Morput"]
    ...
    def computer_attack(self, player, computer):
        ...
        #Call the appropiate attack method based on the given move
        if move == 1:
...
while playing_main:
    ...
    while player.is_alive:
        ...
        print("\nOH NO! A wild " + computer.name + " has appeared!")
        computer.show_stats()

        #While this enemy pykemon is alive and the player pykemon is alive, engange in battle
